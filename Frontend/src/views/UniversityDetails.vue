...
/* فرض خط التجوال على كل عنصر داخل هذه الصفحة */
* {
    ...
    facultiesData: [
      {
        ...
        majors: [
          {
            name: "علم الحاسوب (CS)", hours: 132, field: "IT", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة شاملة للبرمجة، الخوارزميات، وهياكل البيانات، مع التركيز على حل المشكلات برمجياً.",
            careers: ["مطور برمجيات", "محلل أنظمة", "مبرمج تطبيقات", "مهندس بيانات", "أكاديمي"]
          },
          {
            name: "نظم المعلومات الحاسوبية (CIS)", hours: 132, field: "IT", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "الربط بين التكنولوجيا والأعمال من خلال إدارة قواعد البيانات وتطوير النظم المعلوماتية.",
            careers: ["مدير قواعد بيانات", "محلل أعمال تقني", "مصمم نظم", "مسؤول أمن معلومات", "مطور ويب"]
          },
          {
            name: "نظم المعلومات الإدارية (MIS/BIT)", hours: 132, field: "IT", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دمج تكنولوجيا المعلومات بإدارة الأعمال وتطوير المنظومات التقنية للشركات.",
            careers: ["محلل أعمال", "مدير نظم معلومات", "مستشار تقني", "محلل بيانات أعمال"]
          },
          {
            name: "الأمن السيبراني (CYS)", hours: 132, field: "IT", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "حماية الأنظمة والشبكات من الهجمات الرقمية وتأمين البيانات الحساسة.",
            careers: ["أخصائي أمن سيبراني", "محلل اختراق", "مستشار أمن بيانات", "محقق جنائي رقمي"]
          },
          {
            name: "علم البيانات والذكاء الاصطناعي (AI)", hours: 132, field: "IT", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تحليل البيانات الضخمة وبناء نماذج الذكاء الاصطناعي وتطوير تعلم الآلة.",
            careers: ["عالم بيانات", "مهندس ذكاء اصطناعي", "محلل بيانات ضخمة", "مطور خوارزميات"]
          },
          {
            name: "نظم المعلومات الصحية (HIS)", hours: 132, field: "IT", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "إدارة وتطوير الأنظمة التقنية المستخدمة في المستشفيات وقطاع الرعاية الصحية.",
            careers: ["محلل نظم صحية", "مدير بيانات طبية", "مطور أنظمة مستشفيات", "أخصائي معلوماتية طبية"]
          },
          {
            name: "تطوير تطبيقات الأجهزة الذكية", hours: 132, field: "IT", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تصميم وبرمجة تطبيقات الهواتف الذكية والأجهزة اللوحية (Android & iOS).",
            careers: ["مطور تطبيقات أندرويد", "مطور تطبيقات iOS", "مهندس برمجيات موبايل", "مبرمج واجهات مستخدم"]
          }
        ]
      },
      {
        name: "كلية العلوم الطبية التطبيقية", icon: "🩺",
        majors: [
          {
            name: "العلوم الطبية المخبرية", hours: 136, field: "صحي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "إجراء التحاليل المخبرية السريرية للمساعدة في تشخيص الأمراض وعلاجها.",
            careers: ["أخصائي مختبرات طبية", "باحث طبي", "فني بنك دم", "مفتش جودة طبية"]
          },
          {
            name: "التغذية السريرية والحميات", hours: 136, field: "صحي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تقييم الحالة الغذائية للمرضى وتصميم برامج غذائية علاجية للوقاية من الأمراض.",
            careers: ["أخصائي تغذية سريرية", "مستشار غذائي", "مشرف تغذية في المستشفيات", "أخصائي حميات"]
          },
          {
            name: "علوم السمع والنطق", hours: 136, field: "صحي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تشخيص وعلاج اضطرابات السمع والنطق واللغة والتواصل لدى مختلف الفئات العمرية.",
            careers: ["أخصائي سمع ونطق", "معالج لغوي", "باحث في اضطرابات التواصل", "أخصائي تأهيل"]
          },
          {
            name: "العلاج الوظيفي", hours: 136, field: "صحي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تأهيل الأشخاص الذين يعانون من إعاقات جسدية أو نفسية لاستعادة استقلاليتهم في الحياة اليومية.",
            careers: ["أخصائي علاج وظيفي", "مستشار تأهيل مجتمعي", "أخصائي دمج", "مقوم حركي"]
          },
          {
            name: "العلاج الطبيعي", hours: 136, field: "صحي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تقييم وعلاج الاضطرابات الحركية الناتجة عن الإصابات أو الأمراض باستخدام التقنيات الفيزيائية.",
            careers: ["أخصائي علاج طبيعي", "أخصائي تأهيل رياضي", "مدير مركز علاج طبيعي", "باحث حركي"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            name: "التمريض", hours: 132, field: "صحي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "تأهيل كوادر تمريضية لتقديم الرعاية الصحية الشاملة في المستشفيات والمراكز.",
            careers: ["ممرض قانوني", "مشرف تمريض", "ممرض عناية مركزة", "باحث صحي"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            name: "هندسة العمارة", hours: 165, field: "هندسي", duration: "5 سنوات", isNew: false, showCareers: false,
            description: "تصميم المباني والفضاءات المعمارية مع الاهتمام بالتراث واستدامة المنشآت.",
            careers: ["مهندس معماري", "مصمم داخلي", "مخطط عمراني", "مدير مشاريع هندسية"]
          },
          {
            name: "الهندسة المدنية", hours: 162, field: "هندسي", duration: "5 سنوات", isNew: false, showCareers: false,
            description: "تصميم وتنفيذ البنى التحتية، الجسور، والمباني وإدارة مواقع البناء.",
            careers: ["مهندس إنشائي", "مدير موقع", "مهندس طرق وجسور", "مقدر تكاليف"]
          },
          {
            name: "هندسة المساحة", hours: 162, field: "هندسي", duration: "5 سنوات", isNew: false, showCareers: false,
            description: "المسح الجيوديسي، الخرائط الرقمية، ونظم المعلومات الجغرافية (GIS) للأغراض الإنشائية.",
            careers: ["مهندس مساحة", "أخصائي مسح جوي", "خبير تسوية أراضي", "مهندس طرق"]
          },
          {
            name: "هندسة الطاقة المتجددة والمستدامة", hours: 162, field: "هندسي", duration: "5 سنوات", isNew: false, showCareers: false,
            description: "تصميم وإدارة أنظمة الطاقة الشمسية وطاقة الرياح والتقنيات الخضراء.",
            careers: ["مهندس طاقة شمسية", "مستشار طاقة مستدامة", "مصمم محطات طاقة", "باحث طاقة"]
          },
          {
            name: "الهندسة الصناعية", hours: 162, field: "هندسي", duration: "5 سنوات", isNew: true, showCareers: false,
            description: "تحسين وتطوير العمليات الصناعية والأنظمة لزيادة الكفاءة وتقليل التكاليف.",
            careers: ["مهندس صناعي", "مدير إنتاج", "مهندس جودة", "مخطط سلاسل إمداد"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            name: "المحاسبة", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "إدارة السجلات المالية، التدقيق، والتقارير المالية للمؤسسات.",
            careers: ["محاسب", "مدقق حسابات", "مدير مالي", "محاسب ضريبي"]
          },
          {
            name: "إدارة الأعمال", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "أساسيات الإدارة، التسويق، الموارد البشرية، والتخطيط الاستراتيجي.",
            careers: ["مدير إداري", "أخصائي موارد بشرية", "رائد أعمال", "مستشار إداري"]
          },
          {
            name: "التمويل والمصارف", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "إدارة الاستثمارات، العمليات البنكية، والأسواق المالية.",
            careers: ["موظف بنك", "محلل مالي", "مدير استثمار", "محلل مخاطر"]
          },
          {
            name: "الاقتصاد الرقمي", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "التحليل الاقتصادي للأسواق الرقمية والتجارة الإلكترونية واتخاذ القرارات الاقتصادية.",
            careers: ["محلل اقتصادي رقمي", "مستشار أعمال إلكترونية", "باحث سوق", "محلل استثماري"]
          },
          {
            name: "النظم المحاسبية وتحليل الأعمال", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "الدمج بين التقنيات الحاسوبية والعمليات المحاسبية واستخراج البيانات المالية.",
            careers: ["محلل بيانات مالية", "مدقق نظم مالية", "محاسب تقني", "مستشار أعمال"]
          },
          {
            name: "محاسبة وقانون الأعمال", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "الجمع بين المهارات المحاسبية ومعرفة الإطار القانوني للشركات والتجارة.",
            careers: ["مستشار مالي وقانوني", "مدقق التزام", "محاسب شركات", "محقق مالي"]
          },
          {
            name: "تكنولوجيا مالية (FinTech)", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تطبيق التكنولوجيا في القطاع المالي، مثل الدفع الإلكتروني والعملات الرقمية والبنوك الذكية.",
            careers: ["محلل تكنولوجيا مالية", "مطور منتجات مالية", "مستشار FinTech", "أخصائي بلوكتشين"]
          },
          {
            name: "التسويق الرقمي", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "استراتيجيات التسويق عبر الإنترنت، تحليل السلوك الرقمي للمستهلكين، وإدارة الحملات الإعلانية.",
            careers: ["مدير تسويق رقمي", "أخصائي SEO", "مدير حملات إعلانية", "محلل تسويق"]
          },
          {
            name: "الإدارة اللوجستية", hours: 132, field: "أعمال", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "إدارة سلاسل الإمداد، النقل، التخزين، وتوزيع المنتجات بكفاءة.",
            careers: ["مدير سلاسل إمداد", "منسق لوجستي", "مدير مشتريات", "مدير مستودعات"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            ...
            description: "دراسة النظريات الرياضية، الإحصاء، والنمذجة التي تخدم العلوم والتكنولوجيا.",
            careers: ["معلم رياضيات", "محلل إحصائي", "عالم بيانات", "محلل مالي"]
          },
          {
            name: "الفيزياء", hours: 132, field: "علمي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "فهم قوانين الكون، المادة، والطاقة مع تطبيقات في المختبرات والبحث العلمي.",
            careers: ["فيزيائي طبي", "باحث علمي", "معلم فيزياء", "فني مختبرات"]
          },
          {
            name: "الكيمياء", hours: 132, field: "علمي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة العناصر والتفاعلات الكيميائية وتطبيقاتها في الصناعة والدواء.",
            careers: ["كيميائي صناعي", "فاحص جودة", "باحث دوائي", "معلم كيمياء"]
          },
          {
            name: "العلوم الحياتية", hours: 132, field: "علمي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الكائنات الحية، علم الوراثة، والأحياء الدقيقة وتفاعلاتها البيئية.",
            careers: ["باحث بيولوجي", "فني مختبرات", "أخصائي علم وراثة", "معلم أحياء"]
          },
          {
            name: "علوم الأرض والبيئة التطبيقية", hours: 132, field: "علمي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الجيولوجيا، المعادن، والموارد المائية وتأثيراتها البيئية.",
            careers: ["جيولوجي", "محلل بيئي", "مستشار مياه", "مهندس تعدين"]
          },
          {
            name: "نظم المعلومات الجغرافية والاستشعار عن بعد", hours: 132, field: "علمي", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "تحليل البيانات المكانية والخرائط الرقمية باستخدام الأقمار الصناعية وتقنيات GIS.",
            careers: ["محلل نظم جغرافية (GIS)", "أخصائي استشعار عن بعد", "مخطط مدن", "خبير خرائط"]
          }
        ]
      },
      {
        name: "كلية الآداب والعلوم الإنسانية واللغات", icon: "📖",
        majors: [
          {
            name: "اللغة العربية وآدابها", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الأدب العربي، النحو، والبلاغة والتراث اللغوي.",
            careers: ["معلم لغة عربية", "محرر لغوي", "صحفي", "كاتب محتوى"]
          },
          {
            name: "اللغة الإنجليزية وآدابها", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "الأدب الإنجليزي، اللغويات، ومهارات الترجمة والاتصال.",
            careers: ["معلم إنجليزي", "مترجم", "كاتب محتوى", "منسق علاقات"]
          },
          {
            name: "اللغة والأدب / فرنسي - إنجليزي", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة مزدوجة للغتين الفرنسية والإنجليزية وآدابهما لتعزيز مهارات الترجمة والتواصل الدولي.",
            careers: ["مترجم ثنائي اللغة", "معلم لغات", "موظف دبلوماسي", "مرشد سياحي"]
          },
          {
            name: "إيطالي - إنجليزي", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة اللغة والثقافة الإيطالية والإنجليزية لفتح آفاق في التجارة والسياحة والترجمة.",
            careers: ["مترجم", "منسق في شركات دولية", "معلم لغات", "موظف سفارة"]
          },
          {
            name: "إسباني - إنجليزي", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "إتقان اللغتين الإسبانية والإنجليزية، مما يوفر فرصاً واسعة في الترجمة والمنظمات الدولية.",
            careers: ["مترجم", "موظف علاقات دولية", "معلم لغات", "مرشد سياحي"]
          },
          {
            name: "التاريخ", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "تحليل الأحداث التاريخية والحضارات الإنسانية وتطور المجتمعات.",
            careers: ["باحث تاريخي", "معلم تاريخ", "مرشد سياحي", "محافظ آثار"]
          },
          {
            name: "جغرافيا تطبيقية", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الظواهر الطبيعية والبشرية وتطبيقها في التخطيط الحضري والبيئي.",
            careers: ["معلم جغرافيا", "باحث بيئي", "مخطط إقليمي", "محلل ديموغرافي"]
          }
        ]
      },
      {
        name: "كلية بيت الحكمة للعلوم السياسية", icon: "🏛️",
        majors: [
          {
            name: "العلوم السياسية", hours: 132, field: "أدبي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الأنظمة السياسية، العلاقات الدولية، السياسة العامة، والدبلوماسية.",
            careers: ["محلل سياسي", "دبلوماسي", "باحث في الشؤون الدولية", "صحفي سياسي"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            ...
            description: "تأهيل معلمين متخصصين لتدريس المراحل الأساسية من الصف الأول للثالث.",
            careers: ["معلم مدرسة أساسية", "منسق تعليمي", "مدرب مهارات أطفال", "مشرف تربوي"]
          },
          {
            name: "التربية الخاصة", hours: 132, field: "تربوي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "تعليم ودعم الطلبة ذوي الاحتياجات الخاصة وصعوبات التعلم.",
            careers: ["معلم تربية خاصة", "أخصائي صعوبات تعلم", "مستشار تربوي", "معالج سلوكي"]
          },
          {
            name: "التربية البدنية", hours: 132, field: "تربوي", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "إعداد معلمي ومدربي التربية الرياضية وعلوم الحركة.",
            careers: ["معلم تربية رياضية", "مدرب رياضي", "مشرف أنشطة رياضية", "حكم رياضي"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            name: "الفقه وأصوله", hours: 132, field: "شريعة", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة الأحكام الشرعية العملية وقواعد استنباطها من المصادر الأصلية.",
            careers: ["باحث شرعي", "مدرس تربية إسلامية", "واعظ", "قاضٍ شرعي"]
          },
          {
            name: "أصول الدين", hours: 132, field: "شريعة", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة العقيدة، التفسير، والحديث الشريف وعلوم القرآن.",
            careers: ["إمام ومدرس", "داعية", "باحث ديني", "مدرس تربية إسلامية"]
          },
          {
            name: "دراسات في الأديان", hours: 132, field: "شريعة", duration: "4 سنوات", isNew: true, showCareers: false,
            description: "دراسة مقارنة وعميقة للأديان والمذاهب لتعزيز الحوار والفهم العقائدي.",
            careers: ["باحث في الأديان", "مستشار حوار أديان", "مدرس دراسات إسلامية", "كاتب ديني"]
          }
        ]
      },
      {
        ...
        majors: [
          {
            name: "الحقوق", hours: 141, field: "قانون", duration: "4 سنوات", isNew: false, showCareers: false,
            description: "دراسة التشريعات المدنية، الجزائية، والإدارية الأردنية والدولية.",
            careers: ["محامي", "مستشار قانوني", "باحث قانوني", "موظف في القضاء"]
          }
        ]
      }
    ]
